...
const QUEEN = 80000000;//1-10 2L
const QUEEN_LOW_LEVEL = 100000000;//1-10 2L
const QUEEN_ONLY = 40000000;
const QUEEN_ONLY_LOW_LEVEL = 50000000;//1-10 2L
const PARTHM = 7000000;//6-9 2L bxp
// const FULLHM = 9000000;//1-9 2L (assuming other guy already has)
const KING = 80000000;
const KING_CAP = 120000000;
const SKILLER_KING = 100000000;
const POINTS_PART = 40000000; // 6-9 2L points
const FULL_HM_IRON = 80000000; // 1-9 iron
const FULL_HM_UNLOCK = 80000000; //1-9 not unlocked
const FULL_HM_ALREADY_UNLOCK_POINTS = 80000000; // 1-9 already unlocked
...
$(document).ready(function () {
  ...
  table.append("<tr><td><a onclick='showtab(1)'>Wave 10 NM/Queen kill only</a></td><td class='tblprice'>" + commaSeparateNumber(QUEEN_ONLY) + "</td><td class='tblprice'>" + QUEEN_ONLY_T + " minutes</td></tr>");
  table.append("<tr><td><a onclick='showtab(1)'>Wave 10 NM/Queen kill only (low level) </a></td><td class='tblprice'>" + commaSeparateNumber(QUEEN_ONLY_LOW_LEVEL) + "</td><td class='tblprice'>" + QUEEN_ONLY_T + " minutes</td></tr>");
