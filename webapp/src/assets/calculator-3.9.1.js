...
var QUEEN = 18000000;//1-10 2L
var PARTHM = 5000000;//6-9 2L
var FULLHM = 9000000;//1-9 2L (assuming other guy already has)
var KING = 23000000;
var SKILLER_KING = 26000000;
var POINTS_PART = 10000000; // 6-9 points
var IRON_POINTS = 22000000; // 1-9 iron
var FULL_HM_UNLOCK = 18000000; //1-9 not unlocked
...
$(document).ready(function () {
  ...
  table.append("<tr><td>Waves 1-9 HM (if already unlocked, see below)*</th><td class='tblprice'>" + commaSeparateNumber(FULL_HM_ALREADY_UNLOCK) + "</td><td class='tblprice'>" + FULLHM_T + " minutes</td></tr>");
