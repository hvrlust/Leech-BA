...
export class QueueAddComponent implements AfterViewInit, DoCheck {
  isValid = false;
  selected = {
    bxp: false,
    points: false,
  ...
  scrollable = false;
  constructor(
    public dialogRef: MatDialogRef<QueueAddComponent>, private queueService: QueueService, private renderer: Renderer2)  {
  }
  ngDoCheck() {
